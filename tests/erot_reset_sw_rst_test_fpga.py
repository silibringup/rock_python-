...
#            helper.perror("Mismatch, %s's value is not as expected" % reg.name)
    ...
    # NOT test IB1_I2C on FPGA, since J2H_init would do ovr on IB1_I2C rst, then func sw rst not work here
