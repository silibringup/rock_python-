...
LIGHT_ON_LIST = [
    ...
    {'name' : 'PADCTRL_E',      'reg' : erot.PADCTRL_E.AP0_BOOT_CTRL_0_N_GP01_0         }, 
    {'name' : 'PADCTRL_N',      'reg' : erot.PADCTRL_N.MRAM_WP_N_0         		        }, 
    {'name' : 'PADCTRL_S',      'reg' : erot.PADCTRL_S.EROT_LED_GP23_0         		    }, 
    {'name' : 'PADCTRL_W',      'reg' : erot.PADCTRL_W.AP1_BOOT_CTRL_0_N_GP12_0         }, 
    {'name' : 'L1_CSR',         'reg' : erot.L1_CSR.BOOT_QSPI_CORE_BLF_WRITE_CTL_0      }, 
    {'name' : 'L2_CSR',         'reg' : erot.L2_CSR.GPIO_CMN_BLF_READ_CTL_0         	}, 
    {'name' : 'PUF_DBG',        'reg' : erot.PUF_DBG.PUF_ARRAY_CFG_0_0         		    } 
]
