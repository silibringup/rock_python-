...
with Test(sys.argv) as t:
    ...
    helper.pinfo("ROUND 1: TO BURN OPT_ENABLE_HW_FLOP_CLEAR - EXPECTING FAILURE")
    options = parse_args()
    fuse_hash_path = options.hash
    [row_idx, bit_idx, _] = test_api.fuse_get_addr(fuse_hash_path, 'opt_enable_hw_flop_clear')
    row_data, reg_fuse = 0x1 << bit_idx, erot.FUSE.OPT_ENABLE_HW_FLOP_CLEAR_0
    burn_fuse_check(0, row_idx, row_data, 0, reg_fuse)