...
#erot_top sim: nvrun run_test -u erot_top -py erot_j2h_debug_test.py --platform JTAG -pyarg "--log_level DEBUG" -w
...
with Test(sys.argv) as t:
    ...
    if act_data != 0x5a5a5a5a:
        helper.perror("SYSCTRL receive wrong read data from TDO, expected 0x5a5a5a5a while receiving 0x%x" % (act_data))
    ...
    if act_data != 0x5a5a5a5a:
        helper.perror("I2C_IB0 receive wrong read data from TDO, expected 0x5a5a5a5a while receiving 0x%x" % (act_data))
