...
with Test(sys.argv) as t:
    ...
    helper.log("###################################################################################################")
    helper.log("####################################### HW BOOT Test Starts! ######################################")
    helper.log("###################################################################################################")
    ...
    sys_status_poll("111")
    helper.log("###################### HW BOOT done #######################")

    # J2H feature would be verified after this test, better to skip J2H to decrease test dependency
#    #############################################################################################################
#    ################################################ J2H unlock #################################################
#    #############################################################################################################
...
#    ################################################# J2H read ##################################################
#    #############################################################################################################
#    helper.wait_rpi_time(5)    # wait 5us
