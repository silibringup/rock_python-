...
cp ../openocd/src/helper/options.c src/helper/options.c.new 
...
#mv src/jtag/helper/options.c src/helper/options.c.old 
...
#cp src/jtag/src/helper/options.c.new  src/helper/options.c
